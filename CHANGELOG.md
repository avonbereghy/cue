...
- Supply-chain CI: `cargo audit` + `npm audit` (`security-audit` workflow), plus
  ...
  activate automatically when the repository goes public.
...
### Changed
- Hardened GitHub Actions: workflows now default to a read-only `GITHUB_TOKEN`,
...
Baseline for the public open-source release.
...
[Unreleased]: https://github.com/avonbereghy/cue/commits/main
[0.2.0]: https://github.com/avonbereghy/cue/releases
