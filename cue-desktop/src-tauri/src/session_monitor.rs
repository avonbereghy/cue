...
/// (e.g. `media_indexer` → real dir `-Users-…-media-indexer`)
...
mod tests {
    ...
    fn test_encode_workspace_path_special_chars() {
        ...
        // Verified live: /Users/dev/Projects/Tools/media_indexer maps
        // to -Users-dev-Projects-Tools-media-indexer on disk.
        assert_eq!(
